...
- Emma uses [Claude Code](https://docs.anthropic.com/en/docs/claude-code) by Anthropic to power its AI features
- The Schema Builder, Query Builder, and Template Builder all use Claude to understand infrastructure concepts and generate appropriate schemas, queries, and templates
- Claude Code CLI must be installed and authenticated before using AI features
- Review AI-generated output carefully before using it in production
