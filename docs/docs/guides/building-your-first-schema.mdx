...
- Claude Code CLI installed and authenticated (see [Installation](../getting-started/installation.mdx))
...
2. **Verify AI configuration** - Ensure Claude Code is installed and authenticated
